...
@Composable
fun DnsScreen() {
    val viewModel = remember { DnsViewModel() }
    ...
    Column(
        ...
        Text(text = "DNS Settings", style = MaterialTheme.typography.titleLarge)
        ...
        OutlinedTextField(
            ...
            label = { Text("Enhanced Mode (fake-ip/redir-host)") },
        ...
        OutlinedTextField(
            ...
            label = { Text("Nameserver (one per line)") },
            modifier = Modifier
                .fillMaxWidth()
                .height(120.dp),
            enabled = !state.isLoading,
        ...
        OutlinedTextField(
            ...
            label = { Text("Default Nameserver (one per line)") },
            modifier = Modifier
                .fillMaxWidth()
                .height(120.dp),
            enabled = !state.isLoading,
        ...
        OutlinedTextField(
            ...
            label = { Text("Fallback (one per line)") },
            modifier = Modifier
                .fillMaxWidth()
                .height(120.dp),
            enabled = !state.isLoading,
