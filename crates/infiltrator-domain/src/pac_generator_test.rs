...
#[test]
fn test_live_rule_values_are_escaped_before_pac_embedding() {
    let generator = PacGenerator::new(r#"127.0.0.1:7890"; alert(1); //"#);
    let rules = vec![RuleEntry {
        rule: r#"DOMAIN,evil"); return "DIRECT"; //,PROXY"#.to_string(),
        enabled: true,
    }];
