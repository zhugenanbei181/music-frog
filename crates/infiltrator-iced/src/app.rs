    ...
    pub(crate) fn empty() -> Self {
        ...
        Self {
            runtime: crate::state::RuntimeState {
                ...
                custom_node_name_input: String::new(),
                custom_node_server_input: String::new(),
                custom_node_port_input: "443".to_string(),
                custom_node_type_input: "vless".to_string(),
                custom_node_uuid_input: String::new(),
                custom_node_sni_input: String::new(),
                custom_node_exported_uri: None,
            ...
            profile: crate::state::ProfileState {
                ...
                aggregator_result_summary: None,
