...
| 组 07 订阅生命周期与定时更新 | 15 | `parity-ready` | `subscription`、`filter` 管道 | 2026-09-22 起逐项展开（见组 07 逐项账目）：07-01/02/03/04/05/06/07/08/10/11/12/13/15 已双端收口，仅 07-09/14 仍为 `planned` |
