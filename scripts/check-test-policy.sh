...
require_text ".github/workflows/test.yml" "lifecycle-sync-guard.py"
require_text ".github/workflows/test.yml" "lifecycle-matrix-guard.py"
require_text ".github/workflows/test.yml" "tun-stack-guard.py"
require_text ".github/workflows/test.yml" "mtu-negotiation-guard.py"
require_text ".github/workflows/test.yml" "tun-routing-guard.py"
require_text ".github/workflows/test.yml" "system-proxy-guard.py"
require_text ".github/workflows/test.yml" "system-proxy-watchdog-guard.py"
require_text ".github/workflows/test.yml" "system-proxy-recovery-guard.py"
require_text ".github/workflows/test.yml" "lan-sharing-guard.py"
require_text ".github/workflows/test.yml" "lan-security-guard.py"
require_text ".github/workflows/test.yml" "ipv6-routing-guard.py"
require_text ".github/workflows/test.yml" "uwp-loopback-guard.py"
require_text ".github/workflows/test.yml" "pac-service-guard.py"
require_text ".github/workflows/test.yml" "network-roaming-guard.py"
require_text ".github/workflows/test.yml" "vpn-service-guard.py"
